 ...
 * @since 2020
 */
public class InicioTennis extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("TABLA DE POSICIONES TENNIS GAME");
        ...
        fondolbl.setBackground(new java.awt.Color(204, 0, 51));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InicioTennis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
