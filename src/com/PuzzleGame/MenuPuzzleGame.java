...
public class MenuPuzzleGame extends javax.swing.JFrame {
    private int playersCant = 0;
    
    static int contador = 1;
    public MenuPuzzleGame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("TABLA DE POSICIONES PUZZLE GAME");
        ...
        fondolbl.setBackground(new java.awt.Color(0, 204, 255));
        fondolbl.setOpaque(true);
        getContentPane().add(fondolbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 950, 520));

        jLabel6.setFont(new java.awt.Font("Orbitron", 0, 36)); // NOI18N
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("TABLA DE POSICIONES PUZZLE GAME");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 890, 80));
    ...
    public static void setPuntaje(int puntuacion){
        switch (contador){
            ...
            case 2:
                ...
                break;
            case 3:
                puntC.setText(""+puntuacion);
                contador++;
                
                break;
            case 4:
                puntD.setText(""+puntuacion);
                contador++;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuPuzzleGame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
