...
public class MenuBirdGame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("TABLA DE POSICIONES BIRD GAME");
        ...
        fondolbl.setBackground(new java.awt.Color(204, 204, 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuBirdGame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
